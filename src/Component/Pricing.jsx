...
import { features, pricingOptions } from '../constants/Constant'
const Pricing = () => {
  return (
    <div className='mt-20'>
    ...
    {pricingOptions.map((option, index) =>(
      ...
      {option.title}
            ...
            <a href='#'
            className='inline-flex justify-center mt-20 items-center text-center w-full h-12 p-5 tracking-tight text-xl
